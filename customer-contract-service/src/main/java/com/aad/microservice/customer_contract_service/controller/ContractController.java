...
/**
 * Alternative REST controller for CustomerContract entity with /api/contracts mapping
 * This provides compatibility for frontend applications that expect /api/contracts endpoint
 */
@RestController
...
public class ContractController {
    ...
    public ContractController(CustomerContractService contractService) {
        this.contractService = contractService;
    }

    @GetMapping("/health")
    public ResponseEntity<String> healthCheck() {
        return ResponseEntity.ok("Contract Service is working!");
    }
